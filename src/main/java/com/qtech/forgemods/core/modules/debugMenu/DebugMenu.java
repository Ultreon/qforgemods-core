...
import com.qtech.forgemods.core.hud.HudItems;
import com.qtech.forgemods.core.hud.IHasHud;
...
//                    Screen.drawCenteredString(matrixStack, mc.fontRenderer, "<Invalid>", width / 2, height / 2 - 16, 0xbf0000);
                ...
                if (world != null && player != null) {
                    ...
                    drawLeftTopString(matrixStack, "QFM Build", i++, new Formatted(QFMCore.getModArgs().getVersion().getBuild()));
