...
import com.qtech.forgemods.core.crafting.recipe.MixingRecipe;
import com.qtech.forgemods.core.init.ModRecipes;
import com.qtech.forgemods.core.modules.tiles.ModMachineTileEntities;
import com.qtech.forgemods.core.modules.tiles.blocks.machines.AbstractFluidMachineTileEntity;
...
public class MixerTileEntity extends AbstractFluidMachineTileEntity<MixingRecipe> {
    ...
    public MixerTileEntity() {
        super(ModMachineTileEntities.mixer, 4, 5, TANK_CAPACITY, MachineTier.STANDARD);
    }
