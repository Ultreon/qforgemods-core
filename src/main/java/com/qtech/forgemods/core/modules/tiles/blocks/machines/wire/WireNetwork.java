...
import com.qtech.forgemods.core.util.EnergyUtils;
...
public final class WireNetwork implements IEnergyStorage {
    ...
    public int receiveEnergy(int maxReceive, boolean simulate) {
        ...
        if (received > 0) {
//            QForgeUtils.LOGGER.debug("receive ({}): {}, {} -> {}", simulate, received, energyStored, energyStored + received);
            if (!simulate) {
    ...
    public int extractEnergy(int maxExtract, boolean simulate) {
        ...
        if (extracted > 0) {
//            QForgeUtils.LOGGER.debug("extract ({}): {}, {} -> {}", simulate, extracted, energyStored, energyStored - extracted);
            if (!simulate) {
...
//                        QForgeUtils.LOGGER.debug("send {} to {} of {}, accepted {}", toSend, con.side, pos, accepted);
                    }
                }
            }
        }
